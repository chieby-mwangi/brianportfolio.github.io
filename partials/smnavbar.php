...
function smnavbar(){
    ?> 
    <div class="sticky top-0 z-10 flex w-full items-center justify-between border-b bg-white px-4 py-2 md:hidden">
...
?>
                ...
                <div class="" x-data="{ open: false }">
                    <button @click="open = ! open" class="text-gray-400 hover:text-gray-300 focus:text-gray-300 focus:outline-none">
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <a class="flex w-full cursor-pointer items-center space-x-2 px-3 py-2 hover:opacity-90" href="/">
            <img src="/images/brian01.jpg" alt="" class="h-10 w-10 rounded-full transform hover:scale-110 transition duration-300">
            <div class="flex w-full justify-between">
            <div class="flex flex-col">
                <p class="font-sans font-medium text-gray-800">Mwangi Brian</p>
